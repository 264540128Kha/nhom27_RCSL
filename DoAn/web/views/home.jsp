                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="getAo.htm">
                            <img src="/DoAn/views/img/banner14.png" height="275px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="">Kính Cận</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
                    ...
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="getGiay.htm">
                            <img src="/DoAn/views/img/banner13.jpg" height="275px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="">Kính Râm</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
                    ...
                    <div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3">
                        <a class="banner banner-1" href="getQuan.htm">
                            <img src="/DoAn/views/img/banner16.jpg" height="275px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="">Kính 3D</h2>
    ...
    <div class="section section-grey">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="banner banner-1">
                        <img src="/DoAn/views/img/product05.jpg" alt="">
                        <div class="banner-caption text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="/DoAn/views/img/product04.jpg" alt="">
                        <div class="banner-caption text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="/DoAn/views/img/product06.jpg" alt="">
                        <div class="banner-caption text-center">
                            <h2 class="white-color">NEW COLLECTION</h2>
                        </div>
                    </a>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="/DoAn/views/img/product07.jpg" alt="">
